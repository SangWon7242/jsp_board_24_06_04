  ...
  <div class="container mx-auto">
    <form method="POST" onsubmit="ArticleSave__submitForm(this); return false;">
      <div class="flex flex-col gap-y-[5px]">
        ...
        <div>
          <input name="title" type="text" maxlength="50" placeholder="제목을 입력해주세요." class="input input-bordered w-full">
        </div>
      </div>
      ...
      <div class="flex flex-col gap-y-[5px] mt-[10px]">
        ...
        <div>
          <textarea name="body" cols="30" rows="10" placeholder="내용을 입력해주세요." class="textarea textarea-bordered w-full"></textarea>
        </div>
      </div>
